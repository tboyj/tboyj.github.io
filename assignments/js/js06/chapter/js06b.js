...
function validateMonth() {
   ...
   if (month.selectedIndex === 0) {
      month.setCustomValidity("Select a valid expiration month.");
   } else{
...
function validateYear() {
   ...
   if (year.selectedIndex === 0) {
      year.setCustomValidity("Select a valid expiration year.");
   } else{
...
function validateCVC() {
   ...
   if (cvc.validity.valueMissing) {
      cvc.setCustomValidity("Enter the 3-digit code on the back of your card.");
...
function validateNumber() {
   ...
   if (cNum.validity.valueMissing) {
      cNum.setCustomValidity("Please enter your credit card number.");
   } else if (cNum.validity.patternMismatch || !luhn(cNum.value)) {
